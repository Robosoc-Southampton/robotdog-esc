...
{
     _Fract trials[][6] = {
	  {0r, 0r, 0r, 1r, 0.3r, 0.3r},
	  {0r, 0r, 0r, 1r, 0r, 0.3r},
	  {0r, 0.2r, 0r, 1r, 0r, 0.3r},
	  {0r, 0.2r, 1r, 0r, 0r, 0.3r},
	  {0.2r, 0r, 0r, 1r, 0r, 0.3r},
	  {0.2r, 0.2r, 1r, 0r, 0r, 0.3r},
     };
     ...
     {
	  for (t=0; t < 6; t++) {
	       curr_velocity = trials[t][4];
	       target_velocity = trials[t][5];
	       
	       foc_update(trials[t][0], trials[t][1], trials[t][2], trials[t][3]);
